...
/*
    ...
    remarke: i letf some printf statement not necessary for the "user", that i used for debugging and testing. i lef them because i thought they might help you get a clearer picture of what i wanted to do and where did i go wrong etc.
 */
//
//
//
